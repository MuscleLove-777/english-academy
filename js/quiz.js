...
const Quiz = {
    ...
    /**
     * Select an option for a choice question
     */
    ...
    /**
     * Fill in an answer for a fill-blank question
     */
     ...
     */
    submit() {
        // Collect fill-blank answers from inputs
    ...
    /**
     * Finish reviewing and go to next
     */
    finish() {
        const result = this.calculateScore();
        if (result.passed) {
